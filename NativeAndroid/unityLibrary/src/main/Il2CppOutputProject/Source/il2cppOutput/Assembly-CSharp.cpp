...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void SceneManager_LoadAndroidActivity_m91A5F79AE81F48E80FB04476CA325ABEB88619A9 (SceneManager_tC7A8B738D971E14D9BB35AC9A41E754C7B61F821* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		NullCheck(L_3);
		ArrayElementTypeCheck (L_3, _stringLiteral0006A235909142EA4D924F7D004A029C8786208C);
		(L_3)->SetAt(static_cast<il2cpp_array_size_t>(0), (RuntimeObject*)_stringLiteral0006A235909142EA4D924F7D004A029C8786208C);
		NullCheck(L_1);
		AndroidJavaObject_CallStatic_mB677DE04369EDD8E6DECAF2F233116EE1F06555C(L_1, _stringLiteralC14434915C247BF2C63C596EA8744B7C001546AF, L_3, NULL);
		// }
		return;
	}
}
